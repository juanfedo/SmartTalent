...
namespace Presentacion.Controllers
{
    ...
    public class AlimentoController : ControllerBase
    {
        ...
        [HttpPut]
        public async Task<ActionResult> Put(AlimentoDTO alimentoDTO, CancellationToken cancellationToken)
        {
            try
            {
                await _alimentoService.ActualizarAlimentoAsync(alimentoDTO, cancellationToken);
                return Ok();
            }
            catch (Exception ex)
            {
